...
function Login(props) {
  ...
  if (isLoggedIn) {
    return currentUser.roles.includes("ROLE_ADMIN") ? (
      <Navigate to={"/pageadmin"} />
    ) : (
      <Navigate to={"/pagesearch"} />
    );
  }
            ...
            <div className="row h-100 mx-5">
              <div className="col-12 d-flex flex-column justify-content-center">
                ...
                <Form onSubmit={handleLogin} ref={form}>
                  <div className="form-group input-auth">
                  ...
                  <div className="form-group input-auth mt-3">
                  ...
                  <div className="form-group">
                    <button className="btn-auth mt-4" disabled={loading}>
                      {loading && (
